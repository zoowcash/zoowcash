...
#if defined(NDEBUG)
# error "zoowcash cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "zoowcash Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ZCH additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("zoowcash-scriptch");
