...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s zoowcash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zoowcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zoowcash transaction") + "\n" +
              "  zoowcash-tx [options] -create [commands]   " + _("Create hex-encoded zoowcash transaction") + "\n" +
              "\n";
