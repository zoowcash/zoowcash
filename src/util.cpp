...
const char * const BITCOIN_CONF_FILENAME = "zoowcash.conf";
const char * const BITCOIN_PID_FILENAME = "zoowcashd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "zoowcash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/zoowcash";
#else
    // Unix
    return pathRet / ".zoowcash";
#endif
#endif
}
