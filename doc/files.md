...
* zoowcash.conf: contains configuration settings for zoowcashd or zoowcash-qt
* zoowcashd.pid: stores the process id of zoowcashd while running
...
* debug.log: contains debug information and general logging generated by zoowcashd or zoowcash-qt
